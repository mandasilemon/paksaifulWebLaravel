...
<html lang="en">
    ...
    <body id="home">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm fixed-top">
            <div class="container">
                <a class="navbar-brand" href="#">Amanda Callista Ribca Rozeanne</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a class="nav-link active" href="<?php echo e(route('project')); ?>">Projects</a>
...
<?php /**PATH C:\xampp\htdocs\project1\amanda\resources\views/app.blade.php ENDPATH**/ ?>